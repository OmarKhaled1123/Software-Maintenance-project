...
class Ai_ProjectGUI:
    def __init__(self):
        ...
        pvp_button = tk.Button(self.root, text='Player vs Player20', command=lambda: self.set_game_mode('PvP'))
        pvp_button.grid(row=3, column=0)
        pvc_button = tk.Button(self.root, text='Player vs Ai', command=lambda: self.set_game_mode('PvC'))
